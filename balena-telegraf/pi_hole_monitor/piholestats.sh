...
HOSTNAME = os.environ['BALENA_DEVICE_NAME_AT_INIT']  # Pi-hole hostname to report in InfluxDB for each measurement
PIHOLE_API = "http://127.0.0.1/admin/api.php"
INFLUXDB_SERVER = os.environ['INFLUX_URL'] # IP or hostname to InfluxDB server
INFLUXDB_PORT = 8086 # Port on InfluxDB server
INFLUXDB_USERNAME = os.environ['INFLUX_USER']
